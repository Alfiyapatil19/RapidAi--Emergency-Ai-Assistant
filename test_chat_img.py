...
data = {"message": "Can you generate a picture of someone calling an ambulance?", "lang": "en"}
print("Requesting AI Chat...")
resp = requests.post("http://127.0.0.1:5000/ai/chat", json=data)
